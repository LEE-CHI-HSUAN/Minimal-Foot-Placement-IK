...
namespace MinimalIK
{
    public class PlayerController : MonoBehaviour
    {
        ...
        [SerializeField] AdvancedIK footIK;
        ...
        void Update()
        {
            ...
            SetVisual(moveDirection.magnitude);
        ...
        void SetVisual(float moveAmount)
        {
            // 0: idle, 0.5: walk, 1: run
            animator.SetFloat(speed, moveAmount);
            // while walking or idle, snap the feet firmly to the ground.
            // while running, maintain the original motion.
            footIK.controlRotation = moveAmount < 0.7;
        }
    }
}